...
const Response: React.FC = () => {
  ...
  const fetchUserProfiles = () => {
    axios.get('http://localhost:8080/devolutivas/SE/0121/12112310').then((res) => {
  ...
  const temasItems = [
    ...
    ['Direitos e programas sociais', services['']],
    ['Segurança alimentar e nutricional', services['']],
    ['Igualdade entre homens e mulheres', services['']],
    ['Orientação sexual e de identidade de gênero', services['']],
    ['Relações étnico-raciais', services['']],
    ['Prevenção ao uso de álcool e drogas', services['']],
    ['Prevenção à violência', services['']],
    ['Parentalidade', services['']],
    ['Deficiência e acessibilidade', services['']],
    ['Mundo do trabalho', services['']],
  ];
