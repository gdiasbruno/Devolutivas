  ...
  return (
    <>
      ...
      <Section>
        ...
        <h2>
          3. Indique a principal violência sofrida por cada uma das pessoas
          que entraram no serviço no mês, conforme o agente agressor
        </h2>
        <TableThreeColumns headers={motivoSaidaHeaders} body={motivoSaida} />
        <h2>
          3.1. Se houver, indique mais uma violência (diferente da primeira)
          sofrida por cada uma das pessoas que entraram no serviço no mês,
          conforme o agente agressor
        </h2>
        <TableThreeColumns headers={motivoSaidaHeaders} body={motivoSaida} />
        <Typography variant="h5" gutterBottom>
          4. Origem dos encaminhamentos realizados ao serviço no mês.
          Foi informado no (Quadro 1) acima que neste mês entraram:
          0 usuários no serviço. Identifique a origem destes encaminhamentos abaixo.
          pessoa(s)
        </Typography>
        <br />
        <Typography variant="h5" gutterBottom>
          5. Quantos dos 0 casos que entraram no
          mês foram registrados/passaram pelo CREAS antes de serem encaminhados ao serviço?
        </Typography>
        <br />
        <h2>6. Quantidade de pessoas que receberam atendimento técnico no mês</h2>
        <TableTwoColumns headers={familiasAtendidasHeaders} body={familiasAtendidas} />

        <Typography variant="h6" gutterBottom>
          7. Quantidade de usuários por motivo de saída do serviço no mês

        </Typography>

        <h2>
          8. Número de usuários atendidos no mês por tempo de permanência no serviço
        </h2>

        <TableTwoColumns headers={familiasVulnerabilidadeHeaders} body={familiasVulnerabilidade} />

        <h2>
          9. Território de moradia das pessoas atendidas pelo serviço no mês
        </h2>

        <ListComponent items={atividadesItems} />

        <h2>
          10. Número de casos em acompanhamento jurídico no mês
        </h2>

        <ListComponent items={temasItems} />
        <br />
        <h2>
          11. Quantidade de agressores atendidos pelo serviço no mês
        </h2>

        <TableTwoColumns headers={demandaReprimidaHeaders} body={demandaReprimida} />

        <h2>
          12. Quantidade de crianças e adolescentes com deficiência atendidas no mês
        </h2>

        <TableTwoColumns headers={familiasInsumosHeaders} body={familiasInsumos} />

        <h2>
          13. Quantidade de usuários atendidos no mês que também estão acolhidos em SAICAs.
        </h2>

        <TableTwoColumns headers={encaminhamentosHeaders} body={encaminhamentos} />

        <h2>
          14. Quantidade de usuários atendidos no mês
          que também são atendidos em serviços de medidas socioeducativas em meio aberto (MSE/MA)
        </h2>

        <TableTwoColumns headers={atendimentosRemotosHeaders} body={atendimentosRemotos} />

        <h2>
          15. Quantidade de usuários atendidos no mês
          que também são atendidos em serviços de convivência e fortalecimento de vínculos (SCFV)
        </h2>
        ...
        <h2>
          16. Encaminhamentos realizados pelo serviço no mês de referência
        </h2>
        ...
        <h2>
          17. Quantidade de atendimentos remotos de crianças e adolescentes por semana no mês
        </h2>
        ...
        <h2>
          18. Quantidade de atendimentos familiares remotos por semana no mês
        </h2>
