  ...
  return (
    <>
      ...
      <Section>
        ...
        <h2>
          2. Quantidade de pessoas atendidas por sexo e
          raça/cor no serviço de convivência no mês de referência.
        </h2>
        <TableEigthColumns headers={sexoRacaCorHeaders} body={sexoRacaCor} />
        <h2>
          3. Nº de pessoas por motivo de saída do serviço de convivência  no mês de referência:
        </h2>
        <TableThreeColumns headers={motivoSaidaHeaders} body={motivoSaida} />

        <Typography variant="h5" gutterBottom>
          4. N° de idosos atendidos no serviço de convivência que
          moram sozinhos e caso morem sozinhos, quantos contam com alguém se precisarem de ajuda
        </Typography>
        <br />
        <Typography variant="h5" gutterBottom>
          5. Informe os valores das seguites questões sobre
          atendimento às familías dos idosos do serviço de convivência no mês de referência:
        </Typography>
        <br />
        <h2>
          6. Indique o número de famílias ou pessoas que
          buscaram atendimento presencial no serviço de
          convivência mês de referência devido a alguma
          vulnerabilidade relacional listada abaixo
        </h2>
        <TableTwoColumns headers={familiasAtendidasHeaders} body={familiasAtendidas} />

        <Typography variant="h6" gutterBottom>
          7. Indique as atividades realizadas com as
          pessoas atendidas pelo serviço na modalidade convivência no mês de referência
        </Typography>

        <h2>
          8. Indique os temas discutidos com as pessoas
          atendidas pelo serviço na modalidade convivência no mês de referência
        </h2>

        <TableTwoColumns headers={familiasVulnerabilidadeHeaders} body={familiasVulnerabilidade} />

        <h2>
          9. Quantidade de atendimentos remotos de
          usuários do serviço de convivência por semana no mês
        </h2>

        <ListComponent items={atividadesItems} />

        <h2>
          10. Quantidade de atividades remotas realizadas
          pelo serviço de convivência no mês, pelos meios em que foram disponibilizadas
        </h2>
        ...
        <h2>
          ...
          familiares no serviço de convivência por semana no mês
        </h2>
        ...
        <h2>
          12. Quantidade de pessoas atendidas do serviço em domicílio no mês de referência:
        </h2>

        <TableTwoColumns headers={familiasInsumosHeaders} body={familiasInsumos} />

        <h2>
          13. Quantidade de pessoas atendidas por
          sexo e raça/cor no serviço em domicílio no mês de referência.
        </h2>

        <TableTwoColumns headers={encaminhamentosHeaders} body={encaminhamentos} />

        <h2>
          14. Nº de pessoas por motivo de saída do serviço em domicílio  no mês de referência:
        </h2>

        <TableTwoColumns headers={atendimentosRemotosHeaders} body={atendimentosRemotos} />

        <h2>
          15. N° de idosos atendidos no serviço em
          domicílio que moram sozinhos e caso
          morem sozinhos, quantos contam com alguém se precisarem de ajuda
        </h2>
        ...
        <h2>
          16. Informe os valores das seguites
          questões sobre atendimento às famílias
          dos idosos do serviço em domicílio no mês de referência:
        </h2>
        ...
        <h2>
          17. Indique o número de famílias ou pessoas
          que buscaram atendimento presencial do
          serviço em domicílio no mês de referência
        ...
        <h2>
          18. Quantidade de atendimentos remotos de
          usuários do serviço em domicílio por semana no mês
        </h2>
        ...
        <h2>
          19. Quantidade de atividades remotas realizadas
          pelo serviço em em domicílio no mês, pelos meios em que foram disponibilizadas
        </h2>
        ...
        <h2>
          20. Quantidade de atendimentos remotos de
        ...
        <h2>
          21. Nº de pessoas com deficiência atendidas no mês de referência:
        </h2>
        ...
        <h2>
          22. Nº de pessoas incluídas em lista de espera (demanda reprimida) no mês de referência:
        </h2>
        ...
        <h2>
          23. Nº de encaminhamentos realizados pelo serviço no mês de referência:
        </h2>
        ...
        <h2>
          24. Quantifique as informações abaixo com os dados do mês de referência:
        </h2>
        ...
        <h2>
          25. Nº de idosos que receberam insumos no mês de referência:
        </h2>
